  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      <div>
        ...
        />
        {errors.name && <p className="mt-1.5 text-xs text-error-700">{errors.name.message}</p>}
      </div>
      ...
      <div>
        <input
          ...
          className="h-14 w-full rounded-2xl border border-neutral-300 px-4 text-base text-neutral-900 placeholder:text-neutral-500 focus:border-primary-500 focus:outline-none"
        />
        {errors.email && <p className="mt-1.5 text-xs text-error-700">{errors.email.message}</p>}
      </div>
      ...
      <div>
        ...
        {errors.phone && <p className="mt-1.5 text-xs text-error-700">{errors.phone.message}</p>}
      </div>
      ...
      <div className="relative">
        ...
        <ChevronDown className="pointer-events-none absolute right-4 top-1/2 size-5 -translate-y-1/2 text-neutral-500" />
        {errors.budget && <p className="mt-1.5 text-xs text-error-700">{errors.budget.message}</p>}
      </div>
      ...
      <label className="flex items-start gap-3 rounded-2xl border border-neutral-300 px-4 py-3.5">
        <input
          ...
          type="checkbox"
          className="mt-0.5 size-5 shrink-0 rounded-md border-neutral-400 text-primary-500 focus:ring-primary-500"
        />
      ...
      <label className="flex items-start gap-3 rounded-2xl border border-neutral-300 px-4 py-3.5">
        ...
        <span className="text-sm leading-snug text-neutral-800">
          ...
          <a
            href="https://instagram.com/ganpati_interiors"
            target="_blank"
          ...
          or{" "}
          <a
            href="https://share.google/7xhc17BcyZhMHiF7G"
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold text-primary-600 underline"
          >
